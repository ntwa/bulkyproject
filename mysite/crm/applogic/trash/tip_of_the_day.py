          ...
          for record in intermediaries_tuple.items():
               ...
               if(user["D2"]=="None"):
                   continue
                    ...
                    feedback_message="Tip of the day: Hey %s "%first_name

                    feedback_message=feedback_message+"! the only way to acquire a new badge is to use the app to share the app information with your  %s so that she/he can walk more steps. Every new badge gives you points that you can use to buy fertilizer for your trees in the botanical garden...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1

                    feedback_message="Tip of the day: Hey %s "%first_name

                    feedback_message=feedback_message+"! Your flowers in the garden need fertilizer. You can only get enough points to buy fertilizer when you record every meal eaten by your  %s...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)


                    feedback_message="Tip of the day: Hey %s "%first_name

                    feedback_message=feedback_message+",every new badge gives you a chance to increase the number of fish  %s...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1
                    ...
                    feedback_message=feedback_message+",every meal eaten by %s and recorded can give you points to buy food for your fish...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1
                    ...
                    feedback_message="Tip of the day: Hey %s "%first_name
                    feedback_message=feedback_message+", your fish in the aquarium need food to grow. You can only get enough points to buy fish food when you record every meal eaten by your %s. You can get extra points if your %s eats more fruits and vegetables...[This message was autogenerated by the 'Family Wellness App']"%(beneficiary_relations[posn],beneficiary_relations[posn])
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1


                    feedback_message="Tip of the day: Hi %s "%first_name
                    feedback_message=feedback_message+", the only way to acquire a new badge is to use the app to share the app information with your %s so that she/he can walk more steps. Every new badge gives you points that you can use to buy fertilizer for trees in your garden...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1

                    feedback_message="Tip of the day: Whats up %s "%first_name
                    feedback_message=feedback_message+", get a new badge if you want more fish in your tank. You can only obtain a new badge  only if you continue to use the app everyday and motivate  your %s to walk more steps everyday. Log on the app now to check your current badge....[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1


                    feedback_message="Tip of the day: Hello %s "%first_name
                    feedback_message=feedback_message+", your fish need food too. Record more food eaten by your %s for your fish to grow bigger...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1

                    feedback_message="Tip of the day: Hey %s "%first_name
                    feedback_message=feedback_message+", your plants in the garden need fertilizer to grow. You can only have enough money to buy more fertilizer by getting higher badges and recording more food eaten by your %s...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1

                    feedback_message="Tip of the day: Hey %s "%first_name
                    feedback_message=feedback_message+",a badge is only attained if your %s walk more steps and you keep on using the app everyday...[This message was autogenerated by the 'Family Wellness App']"% beneficiary_relations[posn]
                    message_bank.append(feedback_message)
                    message_counter=message_counter+1
