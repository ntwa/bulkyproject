                    ...
                    if res2 is None:
                       ...
                       # num=randint(0,4)
              		  ...
              		  feedback_message="Hey %s "%first_name
                          ...
                          feedback_message=feedback_message+"! These are the people who got new badges last week,%s. Both of them will use use new badges to buy fertilizers to grow trees in their gardens. Motivate your %s to walk more steps in each day so that you can earn a badge too."%(users_with_progress_str, beneficiary_relations[posn])
                          message_bank.append(feedback_message)
                          message_counter=message_counter+1

                          feedback_message="Hallo %s "%first_name

                          feedback_message=feedback_message+"! These are the people who got new badges last week,%s. Both of them will use use new badges to increase number of fish in their tanks. Motivate your %s to walk more steps in each day so that you can earn a badge too."%(users_with_progress_str, beneficiary_relations[posn])
                          message_bank.append(feedback_message)
                          message_counter=message_counter+1
