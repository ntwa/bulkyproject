...
class RetrieveLogData:
    ...
    def getLogs(self):
        ...
        try:
            ...
            print "User\tTotal Sessions\tNo_of_dates_phase_1\tNo_of_dates_phase_2\tNo_of_sessions_phase_1\tNo_of_sessions_phase_2\tTotal_minutes_for_sessions_phase_1\tTotal_minutes_for_sessions_phase_2\tTime_diff_phase 1\tTime_diff_btn_sessions_phase_2"
            for user in res:
                ...
                diff=0
                session_counter=0
                time_diff_btn_sessions_phase_1=0.0
                time_diff_btn_sessions_phase_2=0.0
                ...
                minutes_phase_1=0.0
                minutes_phase_2=0.0
                avg_time_diff_phase_1=0.0
                avg_time_diff_phase_2=0.0
                ...
                for logrecord in reslog:
                    ...
                    if recordposn==0:
                      ...
                      session_counter=session_counter+1 # start counting the first session
                    ...
                    if recordposn>0:
                      ...
                      total_minutes=float(float((days*24*60*60)+(hour*60*60)+(minutes*60)+seconds)/60.0)

            
                      #convert the time to seoncs
                      ...
                      if delta>threshold:
                        all_minutes_for_session_counted=0
                        #print "Session"
                        session_counter=session_counter+1
                        #Categorize those in phase one of experiments vs phase two
                        if datecaptured<demarcation_date:
                          condition_one_counter=condition_one_counter+1
                          time_diff_btn_sessions_phase_1=time_diff_btn_sessions_phase_1+time_minutes
                        else:
                          condition_two_counter=condition_two_counter+1
                          time_diff_btn_sessions_phase_2=time_diff_btn_sessions_phase_2+time_minutes

                      else:
                        if datecaptured<demarcation_date:
                          minutes_phase_1=minutes_phase_1+time_minutes
                          all_minutes_for_session_counted=1
                        else:
                ...
                if all_minutes_for_session_counted ==0:
                  if datecaptured<demarcation_date:

                    minutes_phase_1=minutes_phase_1+1.0
                    all_minutes_for_session_counted=1
                  else:
                    minutes_phase_2=minutes_phase_2+1.0
                    all_minutes_for_session_counted=1
                ...
                if resdates.counter is None:
                    ...
                    if condition_one_counter==0:
                      ...
                      minutes_phase_1=float(minutes_phase_1)
                      avg_time_diff_phase_1=float(time_diff_btn_sessions_phase_1/condition_one_counter)

                 #finish with phase 1
                resdates=session.query(func.count(distinct(Logs.datecaptured)).label("counter")).filter(Logs.intermediary_id==user.id).filter(Logs.datecaptured>=demarcation_date).first()
                if resdates.counter is None:
                    phase_two_total=0
                else:
                    ...
                    if condition_two_counter==0:
                      ...
                      minutes_phase_2=float(minutes_phase_2)
                      avg_time_diff_phase_2=float(time_diff_btn_sessions_phase_2/condition_one_counter)
            



                print "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s"%(user.id,session_counter,phase_one_total,phase_two_total,condition_one_counter,condition_two_counter,minutes_phase_1,minutes_phase_2,avg_time_diff_phase_1,avg_time_diff_phase_2)
