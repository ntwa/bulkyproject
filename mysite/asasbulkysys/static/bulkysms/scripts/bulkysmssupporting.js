...
var retrieveAllContacts=function(){
      ...
      request.done(function( contactsobj ) {
                    ...
                    for(var x in contactsobj)
                    {
                        ...
                        //Get name
                        contact_names=contact_names+addressbookobj[""+x+""]["first_name"];
                        contact_names=contact_names+ " ";
                        contact_names=contact_names+addressbookobj[""+x+""]["last_name"];
                        //contact_ids[name_counter]=addressbookobj[""+x+""]["ContactID"];
                        //address_objects[name_counter]=""+x+"";

                        //get ward
                         contact_ward=contact_ward+addressbookobj[""+x+""]["ward"];

                        //get district

                         contact_district=contact_district+addressbookobj[""+x+""]["district"];

                        //get region

                         contact_region=contact_region+addressbookobj[""+x+""]["region"];



                         contact_country=contact_country+addressbookobj[""+x+""]["country"];
